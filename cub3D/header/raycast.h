...
/*   Updated: 2020/09/06 11:25:55 by gna              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void findwallhit2(int columnid, double horzhitidistance, double verthitdistance);
...
void wallrendering(double dist, int col, int k, int start);
int checksprite();
