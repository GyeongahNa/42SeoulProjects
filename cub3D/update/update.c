...
int update(void)
{
	...
	new_x = g_player_x + cos(g_rotationangle) * movestep - cos(M_PI / 2 - g_rotationangle) * movestep2;
	new_y = g_player_y + sin(g_rotationangle) * movestep + sin(M_PI / 2 - g_rotationangle) * movestep2;
